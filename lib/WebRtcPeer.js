...
function WebRtcPeer(mode, options, callback) {
  ...
  this.replaceTrack = function (stream) {
//     console.log('inside replace track');
//     console.log(pc);
...
//     console.log(sender);
  ...
  this.processAnswer = function (sdpAnswer, callback) {
    ...
    pc.setRemoteDescription(answer)
      ...
      .catch(error => logger.debug('error while setting remote description : ' + error.message));
  ...
  if (mode !== 'recvonly' && !videoStream && !audioStream) {
    ...
    function getScreenMedia(constraints)  {
      ...
      if (typeof AdapterJS !== 'undefined' && AdapterJS
        ...
        navigator.getDisplayMedia(constraints, function (stream) {
          videoStream = stream;
          start();
        }, callback);
      } else {
        navigator.mediaDevices.getDisplayMedia(constraints).then(function (
          stream) {
          videoStream = stream;
